...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _constructor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constructor */ \"./src/common/constructor.js\");\n//Import constructor for new Project and new Class\n\n//Set all projects to null at the beggining\nlet allProjects = [];\n\n//Creates some sample data\n//Programming Project\nallProjects.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Project('Programming'));\nallProjects[0].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('To Do App', 'Make the application as TOP instructions', '2021/02/08', 'high'));\nallProjects[0].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Library Project', 'Make the application as TOP instructions', '2021/02/01', 'high'));\n//Home Project\nallProjects.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Project('Home'));\nallProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Shop', 'Shop the meals', '2021/01/21', 'normal'));\nallProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Paint the house', 'Buy all needed', '2021/02/04', 'low'));\nallProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Buy some clothes', 'Buy clothes', '2021/02/21', 'low'));\nallProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Plant a tree', 'Buy a tree', '2021/02/20', 'low'));\nallProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Make something', 'Buy all ', '2021/02/01', 'low'));\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (allProjects);\n\n//# sourceURL=webpack://todo-list/./src/common/data.js?");
