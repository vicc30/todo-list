...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"data\": () => (/* binding */ data),\n/* harmony export */   \"localSave\": () => (/* binding */ localSave),\n/* harmony export */   \"removeLocal\": () => (/* binding */ removeLocal),\n/* harmony export */   \"getStorage\": () => (/* binding */ getStorage),\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _constructor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constructor */ \"./src/common/constructor.js\");\n//Import constructor for new Project and new Class\n\n//Set all projects to null at the beggining\nlet data = [];\n\n//Local storage save\n//Map each project object local save as project name\nconst localSave = (projects) => projects.map((project) => {\n    localStorage.setItem(project.projectName, JSON.stringify(project));\n});\n\nconst removeLocal = (data) => {\n    localStorage.clear();\n    localSave(data);\n}\n\nconst getStorage = () => {\n    var getProjects = [];\n    //Maps each key value to push it to getProjects array.\n    for (var i = 0; i < localStorage.length; i++) {\n        getProjects\n            .push(\n                JSON.parse(\n                    localStorage.getItem(\n                        localStorage.key(i)\n                    )\n                )\n            );\n    }\n    data = getProjects;\n    return getProjects;\n}\n\nif (localStorage.length === 0) {\n    let newProjects = [];\n    //Creates some sample data if there is no local storage\n    //Programming Project\n    newProjects.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Project('Programming'));\n    newProjects[0].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('To Do App', 'Make the application as TOP instructions', '2021/02/08', 'high'));\n    newProjects[0].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Library Project', 'Make the application as TOP instructions', '2021/02/01', 'high'));\n    //Home Project\n    newProjects.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Project('Home'));\n    newProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Shop', 'Shop the meals', '2021/01/21', 'normal'));\n    newProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Paint the house', 'Buy all needed', '2021/02/04', 'low'));\n    newProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Buy some clothes', 'Buy clothes', '2021/02/21', 'low'));\n    newProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Plant a tree', 'Buy a tree', '2021/02/20', 'low'));\n    newProjects[1].tasks.push(new _constructor__WEBPACK_IMPORTED_MODULE_0__.Task('Make something', 'Buy all ', '2021/02/01', 'low'));\n    //Save new projects in local storage.\n    localSave(newProjects);\n    data = newProjects;\n} else {\n    //if there is local storage calls get function\n    data = getStorage();\n}\n\nconsole.log(data);\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (data);\n\n//# sourceURL=webpack://todo-list/./src/common/data.js?");
